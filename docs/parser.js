...
(function () {
  ...
  const KW = {
    ...
    '샴푸': '생활용품', '린스': '생활용품', '트리트먼트': '생활용품', '바디워시': '생활용품',
    '비누': '생활용품', '치약': '생활용품', '칫솔': '생활용품', '주방세제': '생활용품',
    '세탁세제': '생활용품', '섬유유연제': '생활용품', '물티슈': '생활용품', '키친타올': '생활용품',
    '키친타월': '생활용품', '기저귀': '생활용품', '면봉': '생활용품', '락스': '생활용품',
    '쓰레기봉투': '생활용품', '종량제': '생활용품', '청소용품': '생활용품', '주방용품': '생활용품',
    '건전지': '생활용품', '방향제': '생활용품', '세면도구': '생활용품', '생필품': '생활용품',
  ...
  function detectCat(low) {
    ...
    if (compact.indexOf('용돈') >= 0) return ['용돈', false];  // 용돈 최우선 ("지영 용돈 올리브영"도 용돈)
