...
const TICKER_INFO = {
  ...
  O: '리얼티인컴 · 월배당 리츠', GLD: '금 현물', DEM: '신흥국 고배당', URA: '우라늄 · 원자력',
  // 미국 섹터 ETF (SPDR Select Sector)
  XLK: '미국 기술 섹터', XLV: '미국 헬스케어 섹터', XLF: '미국 금융 섹터',
  XLE: '미국 에너지 섹터', XLU: '미국 유틸리티 섹터', XLY: '미국 임의소비재',
  XLP: '미국 필수소비재', XLI: '미국 산업재', XLB: '미국 소재', XLRE: '미국 리츠', XLC: '미국 커뮤니케이션',
  SOXX: '미국 반도체', SMH: '미국 반도체', SCHG: '미국 성장주', DGRW: '미국 배당성장',
  // 미국 개별주
