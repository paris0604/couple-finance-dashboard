...
const TICKER_INFO = {
  // 미국 ETF
  VOO: '미국 S&P500 · 글로벌 코어', IVV: 'S&P500 (iShares)', SPLG: 'S&P500 (저보수)', SPY: 'S&P500',
  VTI: '미국 전체주식', QQQ: '나스닥100 · 미국 기술주', QQQM: '나스닥100 (저보수)',
  SCHD: '미국 배당성장', JEPI: '미국 커버드콜 배당', JEPQ: '나스닥 커버드콜 배당',
  VT: '전세계 주식', VEA: '선진국 ex-US · 글로벌 코어', VWO: '신흥국', VYM: '미국 고배당',
  DIA: '다우존스30', BND: '미국 종합채권', TLT: '미국 장기국채', SHY: '미국 단기국채',
  O: '리얼티인컴 · 월배당 리츠', GLD: '금 현물', GLDM: '금 (미니) · 하드에셋',
  DEM: '신흥국 가치배당 · 성장분산', URA: '우라늄/원전 · AI인프라',
  // 미국 섹터 ETF (SPDR Select Sector)
  XLK: '미국 기술 섹터', XLV: '헬스케어 · 방어성장', XLF: '미국 금융 섹터',
  XLE: '미국 에너지 섹터', XLU: '유틸리티 · AI인프라', XLY: '미국 임의소비재',
  XLP: '미국 필수소비재', XLI: '미국 산업재', XLB: '미국 소재', XLRE: '미국 리츠', XLC: '미국 커뮤니케이션',
  SOXX: '미국 반도체', SMH: '반도체 · AI직접', SCHG: '미국 성장주', DGRW: '미국 배당성장',
  // 미국 개별주
